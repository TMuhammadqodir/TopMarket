...
public class CartItemCreationValidatorTests
{
    ...
    [InlineData(0, 0, 1, 0)]
    [InlineData(0, 0, 0, 1)]
    public void ShouldBeEqualToFalse(long cartId, long productItemId, decimal price, float quantity)
    {
    ...
    public void ShouldBeEqualToTrue(long cartId, long productItemId, decimal price, float quantity)
    {
        var cartItem = new CartItemCreationDto
        {
            CartId = cartId,
